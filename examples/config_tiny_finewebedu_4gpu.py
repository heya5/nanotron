...
data_stages = [
    ...
    DatasetStageArgs(
        ...
        start_training_step=1,
        data=DataArgs(
            dataset=PretrainDatasetsArgs(hf_dataset_or_datasets="HuggingFaceFW/fineweb-edu", hf_dataset_config_name="sample-10BT", text_column_name="text"),
            seed=seed,
        ),
    ),
]
...
if __name__ == "__main__":
    ...
    config.save_as_yaml(f"{dir}/config_tiny_finewebedu_4gpu.yaml")
